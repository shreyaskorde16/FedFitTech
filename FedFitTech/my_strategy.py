...
class CustomFedAvg(FedAvg):
    ...
    def __init__(self,cfg: DictConfig, model_path: str, plot_path: str, csv_dir_path: str, val_f1_df: pd.DataFrame, 
                 val_f1_client_vs_labels_table: pd.DataFrame, *args,  **kwargs):
        super().__init__(*args, **kwargs)
        """
        Initializes the class with configuration settings, file paths, and validation data.
        ...
        self.val_f1_df = val_f1_df  # Dataframe to store val_f1 scores of all clients per round
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        torch.save(model.state_dict(), os.path.join(self.model_path, f"global_model_round_{server_round}.pth"))
        
        return parameters_aggregated, metrics_aggregated
    
    
    
    def aggregate_evaluate( self, server_round, results, failures, ) -> Tuple[Optional[float], Dict[str, Scalar]]:
