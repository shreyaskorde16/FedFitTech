"""
Plotting function to compare the reesults of the different approaches i.e. One with early stopping and one without early stopping
...
df_ES_client_vs_labels_f1scores = pd.read_csv(ES_client_vs_labels_f1scores_path, sep=";")
df_ES_client_vs_labels_f1scores = df_ES_client_vs_labels_f1scores.rename(columns={'Unnamed: 0': 'Client_Id'})

df_Normal_client_vs_labels_f1scores = pd.read_csv(NORMAL_client_vs_labels_f1scores_path, sep=";")
df_Normal_client_vs_labels_f1scores = df_Normal_client_vs_labels_f1scores.rename(columns={'Unnamed: 0': 'Client_Id'})

# settings
df_ES_client_vs_labels_f1scores = df_ES_client_vs_labels_f1scores.set_index('Client_Id')
df_Normal_client_vs_labels_f1scores = df_Normal_client_vs_labels_f1scores.set_index('Client_Id')



# data_1 : To plot comparision of f1 scores for both EA and Normal approach
data_1 = {"Client_Id": Df_ES_dist_metric["Client_Id"], 
          "F1_score_Normal": Normal_dist_metr["Validation F1 score"], "F1_score_ES": Df_ES_dist_metric["Validation F1 score"],}

df_distributed_metrics_for_plot1= pd.DataFrame(data_1)   # bar plot two f1 score comparison
